...
class Tasksubtype2TableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table("tasksubtype2")->insert([ "id" => 11, "activitytype_id" => 1, "tasktype_id" => 3, "tasksubtype1_id" => 10, "name" => "Motherboard AMB", "description" => "Motherboard AMB", "image" => null, "numsort" => 110, "status" => 1 ]);    
