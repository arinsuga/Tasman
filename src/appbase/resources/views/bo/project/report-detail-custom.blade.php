...
@section('control_sidebar')
    <div class="control-sidebar-content">
        @include('bo.project.report-detail-list-filters')
    </div>
@endsection
...
@section('content')
        ...
        <div>
            ...
            <form role="form" id="frmData" method="POST" action="{{ route('project.report.detail.custom.post') }}" enctype="multipart/form-data">
                @csrf

                <div style="display: flex; justify-content=center;">
                    @include('bo.project.report-detail-custom-fields')
                </div>
            </form>
        ...
        @if (isset($viewModel->data->datalist))
            <div style="margin-top: 10px;">
                @include('bo.project.report-detail-custom-list-items')
            </div>
        @endif
