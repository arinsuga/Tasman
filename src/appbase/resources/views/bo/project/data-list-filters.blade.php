...
<form role="form">
    ...
    <div class="mt-2 row">
        <div class="col-sm-12">
            <div class="form-group">
            <input type="text" id="filter3" name="filter3" class="form-control float-right" placeholder="Jenis Project" style="margin-left: 5px;">
            </div>
        </div>
    </div>
    <div class="mt-2 row">
        <div class="col-sm-12">
            <div class="form-group">
            <input type="text" id="filter4" name="filter4" class="form-control float-right" placeholder="Project" style="margin-left: 5px;">
            </div>
        </div>
    </div>
    <div class="mt-2 row">
